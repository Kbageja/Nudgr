...
export default function Navbar({ sectionRefs }) {
  ...
  return (
    <nav className={`bg-white p-4 sticky top-0 z-50 flex justify-between items-center transition-shadow duration-300 ${!atTop ? 'shadow-sm' : ''}`}>
      <button 
      ...
      <div className="flex items-center space-x-8">
        ...
        <button
          className="bg-black text-white px-4 py-1 rounded-md hover:bg-gray-800 transition-colors duration-300"
        >
          Try Now
        </button>
      </div>
